            ...
            <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1fr)_340px] gap-5 items-start">
                ...
                <table className="w-full border-collapse table-fixed">
                  ...
                  <tbody className="divide-y divide-zinc-200 text-xs sm:text-sm text-zinc-800">
                    <tr>
                      ...
                      <td className="p-3">
                        <span className="inline-flex items-center gap-1.5 text-green-600 font-bold"><span className="w-2 h-2 rounded-full bg-green-600" />Activo</span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="p-3">Herramientas</td>
                      <td className="p-3">
                        <span className="inline-flex items-center gap-1.5 text-red-600 font-bold"><span className="w-2 h-2 rounded-full bg-red-600" />Inactivo</span>
                      </td>
                      <td className="p-3 text-right">
                        <div className="flex justify-end gap-2">
                          <button type="button" className="text-xs font-bold text-black border border-black px-3 py-1.5 rounded-sm hover:bg-zinc-100">Editar</button>
              ...
              <aside aria-labelledby="editar-producto-titulo" className="bg-white border border-black rounded-2xl p-4 sm:p-5 shadow-sm">
                ...
                <form className="space-y-4">
                  <div>
                    <label htmlFor="producto-nombre" className="block text-xs font-bold text-black mb-1">
                      Nombre del producto
                    </label>
                    <input
                      id="producto-nombre"
                  ...
                  <div>
                    <label htmlFor="producto-categoria" className="block text-xs font-bold text-black mb-1">
                      Categoría asociada
                    </label>
                    <select
                  ...
                  <div>
                    <label htmlFor="producto-descripcion" className="block text-xs font-bold text-black mb-1">
                      Descripción
                    </label>
                    <textarea
                  ...
                  <div>
                    <label htmlFor="producto-estado" className="block text-xs font-bold text-black mb-1">
                      Estado
                    </label>
                    <select
                      id="producto-estado"
